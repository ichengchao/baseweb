...
public class CommonConstants {
    ...
    /**
     * 加载顺序:<br>
     * 1. 运行时参数,示例: java -jar -DconfigPath=/home/test/baseweb.properties baseweb.jar <br>
     * 2. baseweb.jar同目录下的baseweb.properties <br>
     * 3. 用户home/config/目录下的baseweb.properties <br>
     * 
     * @return
     */
